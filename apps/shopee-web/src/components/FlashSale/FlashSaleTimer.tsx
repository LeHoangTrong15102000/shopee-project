...
const FlashSaleTimer = ({
  ...
  return (
    <div
      className={`flex items-center space-x-2 rounded-sm bg-orange px-3 py-1 text-white ${className}`}
    >
      {isServerSynced && (
        <span className="mr-1 rounded-sm bg-yellow-400 px-1 py-0.5 text-xs font-bold text-yellow-900">
          ⚡ Live
        </span>
      )}
