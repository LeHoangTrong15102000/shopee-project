      ...
      <div className="relative shrink-0">
        ...
        >
          <span>
            {t('filter.sortBy')}{' '}
            {t(
              (sortOptions.find((s) => s.id === activeSort)
                ?.labelKey as keyof typeof import('src/locales/en/wishlist.json')) ?? '',
            )}
          </span>
            ...
            >
              {sortOptions.map((opt) => (
                ...
                >
                  ...
                  {t(opt.labelKey as keyof typeof import('src/locales/en/wishlist.json'))}
                </Button>
              ))}
            </motion.div>
          )}
