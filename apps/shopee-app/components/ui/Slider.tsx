...
export default function Slider({
  ...
  return (
    <View className={cn('w-full', className)}>
      {label && (
        <Text className={cn('mb-2 font-sans-medium text-foreground', labelClassName)}>{label}</Text>
      )}
      ...
      <View className="flex-row items-center">
        ...
        {showValue && (
          <Text className="ml-3 min-w-12 text-right font-sans-medium text-foreground">
            {sliderValue}
          </Text>
        )}
      </View>
