    ...
    <div>
      ...
      <div className="hidden md:block">
        ...
        <div className="mt-7 ml-2">
          ...
          <Link
            to={path.profile}
            className="mb-3.75 flex items-center justify-start capitalize transition-colors"
          >
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              classNames(
                'relative mb-3.75 flex items-center justify-start capitalize transition-colors',
                {
