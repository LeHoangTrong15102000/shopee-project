...
const protectedRoutes: RouteObject[] = [
  ...
  { path: 'products/:id/edit', element: <SuspenseWrapper><ProductFormPage /></SuspenseWrapper> },
  { path: 'products/:id', element: <SuspenseWrapper><ProductDetailPage /></SuspenseWrapper> },
  { path: 'categories', element: <SuspenseWrapper><CategoryListPage /></SuspenseWrapper> },
  { path: 'orders', element: <SuspenseWrapper><OrderListPage /></SuspenseWrapper> },
  { path: 'orders/:id', element: <SuspenseWrapper><OrderDetailPage /></SuspenseWrapper> },
  { path: 'vouchers', element: <SuspenseWrapper><VoucherListPage /></SuspenseWrapper> },
  { path: 'vouchers/:id', element: <SuspenseWrapper><VoucherDetailPage /></SuspenseWrapper> },
  { path: 'reviews', element: <SuspenseWrapper><ReviewListPage /></SuspenseWrapper> },
  { path: 'reviews/:id', element: <SuspenseWrapper><ReviewDetailPage /></SuspenseWrapper> },
  ...
  { path: 'qa', element: <SuspenseWrapper><QAPage /></SuspenseWrapper> },
