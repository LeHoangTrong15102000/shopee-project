    ...
    <>
      ...
      {isOpen && (
        <div className='fixed right-5 bottom-40 z-50'>
          <Suspense
            fallback={<div className='h-96 w-80 animate-pulse rounded-lg bg-white shadow-xl dark:bg-slate-800' />}
          >
            <ChatWindow conversationId='admin-support' sellerName='Hỗ trợ khách hàng' currentUserId={profile?._id} />
          </Suspense>
        </div>
      )}
    </>
