...
export const addressSchema = z.object({
  fullName: z
    .string()
    .min(1, i18n.t('address:form.fullName.required'))
    .max(100, i18n.t('address:form.fullName.max')),
  phone: z
    .string()
  ...
  street: z
    .string()
    .min(1, i18n.t('address:form.street.required'))
    .max(200, i18n.t('address:form.street.max')),
