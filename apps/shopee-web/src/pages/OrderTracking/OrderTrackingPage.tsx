...
const OrderTrackingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900">
      <SEO title={t('tracking.pageTitle')} description={t('tracking.seoDescription')} />
      ...
      <div className="container py-8">
        ...
        {isLoading && (
          <div className="flex items-center justify-center py-16">
            <div
              className="h-8 w-8 animate-spin rounded-full border-4 border-orange border-t-transparent"
              role="status"
              aria-label="Loading"
            />
          </div>
        ...
        {!submittedNumber && !isLoading && (
          <div className="rounded-sm bg-white p-12 text-center shadow-sm dark:bg-slate-800">
            ...
            <p className="text-gray-500 dark:text-gray-400">{t('tracking.enterNumber')}</p>
          </div>
        )}
