  ...
  return (
    <Button
      ...
      className={classNames(
        'flex items-center justify-center bg-white/80 shadow-xs transition-all duration-200 motion-reduce:transition-none hover:bg-white dark:bg-slate-800/80 dark:hover:bg-slate-700',
        sizeClasses[size],
    ...
    >
      {isLoading ? (
        <svg
          className="h-4 w-4 animate-spin motion-reduce:animate-none text-orange dark:text-orange-400"
          fill="none"
          viewBox="0 0 24 24"
          aria-hidden="true"
        >
