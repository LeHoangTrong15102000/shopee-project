  ...
  data: {
    notifications: [
      ...
      },
      {
        ...
        content:
          'Bạn có 1 voucher miễn phí vận chuyển cho đơn hàng từ 100k. Áp dụng đến hết ngày mai.',
        type: 'promotion' as const,
        isRead: true,
...
const notificationApi = {
  ...
  getUnreadCount: async () => {
    try {
      ...
      console.warn('Unread count API not available, using mock data')
      return { data: { message: 'Mock unread count', data: { unreadCount: 2 } } }
    }
  },
}
