        ...
        <div className="flex flex-col justify-end">
          <div className="flex flex-wrap items-center sm:justify-end md:justify-end">
            <div className="text-sm text-gray-700 sm:text-sm dark:text-gray-200">
              ...
              {isAllChecked ? extendedPurchases.length : checkedPurchaseCount}{' '}
              {t('summary.products')}):{' '}
            </div>
            <motion.div
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-600 dark:text-gray-300">
                          {t('summary.totalGoods')}
                        </span>
                        <span className="text-gray-900 dark:text-gray-100">
                          ₫
                          {formatCurrency(
                            totalCheckedPurchasePrice + totalCheckedPurchaseSavingPrice,
                          )}
                        </span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-600 dark:text-gray-300">
                          {t('summary.voucherDiscount')}
                        </span>
