// DEMO COMPONENT — generates a static VietQR placeholder for UI development only.
// Real QR codes are generated by the payment gateway (MoMo/VNPay) after redirect.
