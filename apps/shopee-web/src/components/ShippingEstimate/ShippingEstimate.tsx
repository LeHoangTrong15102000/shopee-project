...
function ShippingEstimate({
  ...
  return (
    <div className={classNames('rounded-xs bg-gray-50 p-3 sm:p-4 dark:bg-slate-900', className)}>
          ...
          {defaultShippingOptions.map((option) => {
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      {option.id === 'instant' && (
                        <span className="rounded-sm bg-[#ee4d2d] px-1.5 py-0.5 text-xs text-white">
                          {t('fastest')}
                        </span>
                      )}
                    </div>
                ...
                <span className="text-xs font-medium text-[#ee4d2d] sm:text-sm">
      ...
      {selectedOption && (
        <div
          className="mt-4 border-t border-gray-200 pt-3 dark:border-slate-700"
          aria-live="polite"
        >
