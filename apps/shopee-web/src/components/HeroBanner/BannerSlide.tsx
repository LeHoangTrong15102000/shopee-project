    ...
    >
      ...
      <div className="relative z-10 flex h-full items-center px-8 md:px-12">
        <div className="max-w-md text-white">
          <h2 className="mb-2 text-2xl leading-tight font-bold drop-shadow-lg md:text-3xl">
            {slide.title}
          </h2>
          <p className="mb-4 text-sm leading-relaxed opacity-90 drop-shadow-md md:text-base">
            {slide.subtitle}
          </p>
          <Button
            animated={false}
