        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <select
            ...
            className={classNames('h-10 px-4 text-left text-sm capitalize outline-hidden md:h-8', {
              'bg-white/70 text-orange hover:bg-slate-100 dark:bg-slate-700/70 dark:hover:bg-slate-700':
          ...
          >
            <option
              value=""
              className="bg-white text-black/80 dark:bg-slate-800 dark:text-gray-200"
              disabled
            >
              {t('sort.price')}
            </option>
