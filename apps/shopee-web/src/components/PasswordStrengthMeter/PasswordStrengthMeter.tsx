...
const PasswordStrengthMeter = ({ password, className = '' }: PasswordStrengthMeterProps) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="mt-2 h-2 w-full overflow-hidden rounded-full bg-gray-200 dark:bg-slate-600"
        aria-hidden="true"
      >
        {reducedMotion ? (
          <div
      ...
      {label && (
        <div
          className={`mt-1.5 flex items-center justify-end gap-1 text-xs ${currentLevel.textColor}`}
        >
