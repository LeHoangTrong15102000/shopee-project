...
const mobileNavItems = [
  ...
  {
    to: path.priceAlerts,
    label: 'mobile.priceAlerts' as const,
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
...
const MobileAccountNav = ({ className }: MobileAccountNavProps) => {
  ...
  return (
    <div
      ref={dropdownRef}
      className={classNames('relative bg-white md:hidden dark:bg-slate-800', className)}
    >
              ...
              return (
                <Button
                  ...
                  className={classNames(
                    ...
                    {
                      'bg-orange-50 text-[#ee4d2d] dark:bg-orange-900/20 dark:text-orange-400':
                        isActive,
