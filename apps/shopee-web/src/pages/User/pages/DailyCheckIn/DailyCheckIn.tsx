...
const SilverStarIcon = () => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    className="mx-auto h-8 w-8 text-slate-500 dark:text-slate-300"
  >
    <path
...
const GoldTrophyIcon = () => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    className="mx-auto h-8 w-8 text-yellow-500 dark:text-yellow-400"
  >
...
const LightbulbIcon = () => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    className="mr-1 inline-block h-5 w-5 text-amber-500 dark:text-amber-400"
  >
    <path
