...
describe('Admin Notification Schemas', () => {
  describe('adminCreateNotificationSchema', () => {
    it('should accept valid input', () => {
      expect(
        adminCreateNotificationSchema.safeParse({
  ...
  describe('adminBroadcastNotificationSchema', () => {
    it('should accept valid input', () => {
      expect(
        adminBroadcastNotificationSchema.safeParse({
  ...
  describe('adminGetNotificationsSchema', () => {
    it('should accept valid query', () => {
      expect(adminGetNotificationsSchema.safeParse({ query: { page: 1, limit: 10 } }).success).toBe(
        true,
      )
    })
  ...
  describe('adminDeleteNotificationSchema', () => {
    it('should accept valid id', () => {
      expect(adminDeleteNotificationSchema.safeParse({ params: { id: VALID_ID } }).success).toBe(
        true,
      )
    })
