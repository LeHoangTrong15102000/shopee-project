...
const mockProducts: Product[] = [
  ...
  },
  {
    ...
    images: [
      'https://picsum.photos/seed/earphone04/200',
      'https://picsum.photos/seed/earphone04b/200',
    ],
  ...
  // Giày dép
  {
    ...
    images: [
      'https://picsum.photos/seed/sneaker05/200',
      'https://picsum.photos/seed/sneaker05b/200',
    ],
  ...
  // Mỹ phẩm
  {
    ...
    images: [
      'https://picsum.photos/seed/skincare07/200',
      'https://picsum.photos/seed/skincare07b/200',
    ],
  ...
  },
  {
    ...
    images: [
      'https://picsum.photos/seed/lipstick08/200',
      'https://picsum.photos/seed/lipstick08b/200',
    ],
    category: { _id: 'cat-beauty', name: 'Mỹ phẩm' },
    quantity: 120,
    sold: 4500,
  ...
  // Đồ gia dụng
  {
    ...
    images: [
      'https://picsum.photos/seed/blender09/200',
      'https://picsum.photos/seed/blender09b/200',
    ],
