...
export const mockRewards: LoyaltyReward[] = [
  ...
  createMockLoyaltyReward({ _id: 'reward-3', name: 'Free Ship', points_required: 200, is_active: false }),
];
...
export const mockTransactions: LoyaltyTransaction[] = [
  ...
  createMockLoyaltyTransaction({ _id: 'tx-2', type: 'redeem', points: -500, description: 'Đổi voucher' }),
  createMockLoyaltyTransaction({ _id: 'tx-3', type: 'adjust', points: 50, description: 'Admin điều chỉnh' }),
];
