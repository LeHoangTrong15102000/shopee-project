            ...
            return (
              <div key={`${event.timestamp}-${index}`} className="relative flex gap-3 md:gap-4">
                ...
                <div className="relative z-10 shrink-0">
                  <div
                    className={classNames(
                      'flex h-5 w-5 items-center justify-center rounded-full md:h-6 md:w-6',
                      {
                        ...
                        'bg-[#26aa99] shadow-md shadow-[#26aa99]/30 dark:bg-[#26aa99]':
                          isCurrent && !isError,
                  ...
                  >
                    {isPassed && !isError && (
                      <StatusIcon status={event.status} className="h-3 w-3 text-white" />
                    )}
                    {isCurrent && !isError && (
                      <StatusIcon status={event.status} className="h-3 w-3 text-white" />
                    )}
                ...
                <div className={classNames('flex-1 pb-6', { 'pb-0': isLast })}>
                  ...
                  <p className="mt-1 text-xs text-gray-600 md:text-sm dark:text-gray-300">
                    {event.description}
                  </p>
                  {event.location && (
