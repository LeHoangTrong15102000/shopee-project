  ...
  'flex-row items-center justify-center px-4 gap-2 rounded-xl text-sm font-medium',
  {
    variants: {
      ...
      variant: {
        ...
        outline:
          'bg-transparent text-foreground font-semibold border border-neutrals700 hover:bg-neutrals900',
...
export default function AppButton(props: AppButtonProps) {
  ...
  return (
    <AnimatedPressable
      style={animatedStyle}
      className={cn(buttonVariants({ variant, size, disabled: isDisabled, loading }), className)}
      disabled={isDisabled}
