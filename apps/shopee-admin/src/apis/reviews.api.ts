...
const reviewsApi = {
  ...
  getReview: (id: string) =>
    http.get<SuccessResponse<ReviewDetail>>(`admin/reviews/${id}`),

  getReviewStats: () =>
    http.get<SuccessResponse<ReviewStats>>('admin/reviews/stats'),

  deleteReview: (id: string) =>
    http.delete<SuccessResponse<null>>(`admin/reviews/${id}`),

  deleteComment: (id: string) =>
    http.delete<SuccessResponse<null>>(`admin/reviews/comments/${id}`),
}
