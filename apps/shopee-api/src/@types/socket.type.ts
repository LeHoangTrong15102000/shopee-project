...
// Chat message received (server -> client)
...
// User typing indicator (server -> client)
...
// Connected payload (server -> client on successful auth)
...
// Price alert triggered payload (server -> client, sent to specific user)
...
// --- Admin New Order Notification Payload ---

// Admin new order notification payload (server -> client)
